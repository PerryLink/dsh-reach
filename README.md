...
> **Status: Phase 1 complete (WeChat single-channel MVP, v0.1.0).** The design
> plan, competitor research, official contract verification, and phased roadmap
> live in
> [`docs/design/03-rebuild-direction-and-plan.md`](docs/design/03-rebuild-direction-and-plan.md).
> Phase 2 (decision/command enhancements) and Phase 3 (Feishu/Telegram
> adapters) are next.
